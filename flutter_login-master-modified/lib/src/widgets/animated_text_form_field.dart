...
class _AnimatedTextFormFieldState extends State<AnimatedTextFormField> {
  ...
  InputDecoration _getInputDecoration(ThemeData theme, bool finished) {
    return InputDecoration(
      labelText: widget.labelText,
      prefixIcon: widget.loadingController != null
          ? FadeTransition(
              ...
              child: Row(
                ...
                children: [
                  SizedBox(width: 16),
                  SizedBox(width: 30, child: Center(child: widget.prefixIcon!)),
                  SizedBox(width: 16),
                ],
              ),
            )
  ...
  Widget build(BuildContext context) {
    ...
    Widget textField = TextFormField(
      ...
      decoration:
          _getInputDecoration(theme, sizeAnimation.isCompleted).copyWith(
        errorMaxLines: 3,
      ...
      textField = ScaleTransition(
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, child) => ConstrainedBox(
            constraints:
                BoxConstraints.tightFor(width: sizeAnimation.value, height: 60),
            child: child,
          ),
          child: textField,
        ),
