...
class _LoginCardState extends State<_LoginCard> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    skipWidget = auth.skipWidget;
    appleSignInWidget = auth.appleSignInWidget;
  ...
  Widget _buildUsername(double width, Auth auth) {
    return AnimatedTextFormField(
  ...
  Widget _buildPhone(double width, Auth auth) {
    return AnimatedTextFormField(
  ...
  Widget build(BuildContext context) {
    ...
    final cardWidth = max(MediaQuery.of(context).size.width * 0.75, 360.0);
    const cardPadding = 16.0;
    final textFieldWidth = cardWidth - cardPadding * 2;
    final authForm = SizedBox(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      ExpandableContainer(
                        ...
                        child: _buildUsername(textFieldWidth, auth),
                      ),
                      ExpandableContainer(
                        backgroundColor: _switchAuthController.isCompleted
                            ? null
                        ...
                        onExpandCompleted: () =>
                            _postSwitchAuthController.forward(),
                        child: _buildPhone(textFieldWidth, auth),
                      ),
