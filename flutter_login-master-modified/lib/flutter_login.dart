...
class FlutterLogin extends StatefulWidget {
  FlutterLogin(
      ...
      required this.appleSignInWidget,
  ...
  final Widget appleSignInWidget;
...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  Widget build(BuildContext context) {
    ...
    final phoneValidator = widget.phoneValidator;
      ...
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) => Auth(
            ...
            appleSignInWidget: widget.appleSignInWidget,
