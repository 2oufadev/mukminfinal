...
#ifndef FLUTTER_COMPASS_SWIFT_H
#define FLUTTER_COMPASS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_compass",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15flutter_compass25SwiftFlutterCompassPlugin")
@interface SwiftFlutterCompassPlugin : NSObject <CLLocationManagerDelegate, FlutterPlugin, FlutterStreamHandler>
