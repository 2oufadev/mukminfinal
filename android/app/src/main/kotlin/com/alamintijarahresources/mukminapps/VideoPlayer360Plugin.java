...
import com.alamintijarahresources.mukminapps.videoplayer.VideoActivity;
...
/** Tilt Placeholder as instructions how to use the VR Player */
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    final MethodChannel channel = new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "flutter.native/helper");
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter.native/helper");
