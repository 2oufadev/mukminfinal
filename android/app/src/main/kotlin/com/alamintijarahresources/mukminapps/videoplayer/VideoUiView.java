...
import com.alamintijarahresources.mukminapps.videoplayer.rendering.CanvasQuad;
...
public class VideoUiView extends LinearLayout {
   ...
   */
  @MainThread
  public static VideoUiView createForOpenGl(final Context context, ViewGroup parent, CanvasQuad quad) {
  ...
  public void onFinishInflate() {
    ...
    final ImageView playPauseToggle = (ImageView) findViewById(R.id.play_pause_toggle);
        ...
        new OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            if (mediaPlayer.isPlaying()) {
              mediaPlayer.pause();
              playPauseToggle.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.play));
              playPauseToggle.setContentDescription(getResources().getString(R.string.play_label));
            } else {
              mediaPlayer.start();
              playPauseToggle.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.pause));
   ...
   */
  public OnFrameAvailableListener getFrameListener() {
    return uiUpdater;
  }
