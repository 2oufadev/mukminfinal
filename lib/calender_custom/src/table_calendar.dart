...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
  ...
  Widget _buildCell(DateTime day, DateTime focusedDay) {
    HijriCalendar hijCatFoc = HijriCalendar.fromDate(focusedDay);
    HijriCalendar hijCatday = HijriCalendar.fromDate(day);
    final isOutside = hijCatday.hMonth != hijCatFoc.hMonth;
      ...
      builder: (context, constraints) {
        ...
        if (!isDisabled) {
          ...
          if (events.isNotEmpty && markerWidget == null) {
            final center = constraints.maxHeight / 1.9;
