...
class CalendarCore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PageView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        print('baseDay  $baseDay');
        final visibleRange = _getVisibleRange(calendarFormat, focusedDay);
  ...
  List<DateTime> _daysInRange(DateTime first, DateTime last) {
    print('focusdDay $focusedDay');
    print('firstdayinrange $first');
    print('lastdayinrange $last');
  ...
  DateTime _firstDayOfMonth(DateTime month) {
    HijriCalendar hijCal = HijriCalendar.fromDate(month);
    hijCal.hDay = 1;
    return hijCal.hijriToGregorian(hijCal.hYear, hijCal.hMonth, hijCal.hDay);
  }
  ...
  DateTime _lastDayOfMonth(DateTime month) {
    ...
    if (hijCal.hMonth < 12) {
      hijCal.hDay = 1;
      hijCal.hMonth = hijCal.hMonth + 1;
    } else {
      hijCal.hDay = 1;
      hijCal.hMonth = 1;
      hijCal.hYear = hijCal.hYear + 1;
    }

    final date =
        hijCal.hijriToGregorian(hijCal.hYear, hijCal.hMonth, hijCal.hDay);
