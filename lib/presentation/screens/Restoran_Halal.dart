...
class Restoran_Halal extends StatefulWidget {
  @override
  _Restoran_HalalState createState() => _Restoran_HalalState();
}

class _Restoran_HalalState extends State<Restoran_Halal> {
                  ...
                  child: Stack(
                    children: [
                      ListView.separated(
                          ...
                          itemCount:
                              loading ? myList.length + 1 : myList.length,
  ...
  Future nearBySearch(double lat, double lng) async {
    var res = await http.get(Uri.parse(
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?keyword=halal restaurants&location=$lat,$lng&rankby=distance&type=restaurant&key=AIzaSyDxnRT1NxgOqg51V97G_XDGvxOqDVmYhHw"));
    if (res != null) {
