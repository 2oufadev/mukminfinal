class HadithModelSeparate {
  List<Data>? data;
  List<SubImages>? subImages;

  HadithModelSeparate({this.data, this.subImages});

  HadithModelSeparate.fromJson(Map<String, dynamic> json) {
    data = <Data>[];
    json['data'].forEach((v) {
...
class ReadyHadithModelSeparate {
  int? id;
  int? categoryId;
  String? name;
  String? description;
